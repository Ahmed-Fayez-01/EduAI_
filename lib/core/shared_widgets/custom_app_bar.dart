...
class CustomAppBar extends StatelessWidget {
  const CustomAppBar({super.key, this.prefixIcon, required this.title, this.suffixIcon, this.suffixIconSize, this.suffixIconTap, this.prefixIconTap, this.hasTitleNotIcon=false, this.subTitle, this.onTitleTap});
        ...
        children: [
          ...
          if(hasTitleNotIcon!)
            PositionedDirectional(
              ...
              child: InkWell(onTap: onTitleTap,child: Text(subTitle!,style: TextStyle(
