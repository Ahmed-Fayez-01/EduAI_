    ...
    return widget.path != null || file?.path != null
        ? Align(
            ...
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),
                color: widget.isSender ? Colors.white : const Color(0xFF343145),
              ),
              child: Row(
                ...
                children: [
                  ...
                  AudioFileWaveforms(
                    size: Size(MediaQuery.of(context).size.width / 1.8, 70),
                    playerController: controller,
                    waveformType: widget.index?.isOdd ?? false
                        ? WaveformType.fitWidth
                        : WaveformType.fitWidth,
                    playerWaveStyle: PlayerWaveStyle(
                        fixedWaveColor: AppColors.primaryColor.shade200,
                        scaleFactor: 300,
                        showSeekLine: false,
                        liveWaveColor: AppColors.primarySwatchColor),
                  ),
