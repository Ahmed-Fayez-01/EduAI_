...
import 'package:eduai_parent/features/auth/presentation/views/success_reset_password_view.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          DefaultButton(onPress: (){
            ...
            {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>const SuccessResetPasswordView()));
            }
          }, text: "Confirm",borderRadius: AppConstants.sp10(context),),
          SizedBox(height: AppConstants.height30(context)*4,),
        ],
      ),
    );
  }
